            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="single-latest-news text-center bg-transparent shadow-none">
                        <a href="movie_info.php?id=<?= $filmSearch['id'] ?>">
                ...
                <div class="col-sm-8 mt-5">
                    ...
                    <a href="watch.php?id=<?= $filmSearch['id'] ?>" class="btn btn-info text-white p-3 px-5 my-5" style="border-radius:30px">Start Streaming</a><br>
